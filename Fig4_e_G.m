...
% Nt = linspace(20000,200000,100); % N = 1174.5189;
Nt = linspace(20000,80000,100); % N = 1174.5189;
...
title('The day of Crosspoint at S(0) in Guinea','Interpreter', 'latex')
ylim([237 244])
hold off
